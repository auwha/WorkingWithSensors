...
import com.example.workwithsensors.databinding.ActivityAccelerometerSensorBinding;
...
public class AccelerometerSensor extends AppCompatActivity implements SensorEventListener {
    ActivityAccelerometerSensorBinding b;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        b = ActivityAccelerometerSensorBinding.inflate(getLayoutInflater());
